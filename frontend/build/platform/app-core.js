...
/******/ 	var hotCurrentHash = "23848a58b2aa9c224492"; // eslint-disable-line no-unused-vars
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.navigationInject = exports.navigationConfig = exports.navigationController = exports.navigationDirective = exports.navigationService = exports.uiAppConfig = exports.uiAppInject = exports.appInject = exports.appConfig = exports.appController = exports.appDirective = exports.appService = undefined;

	var _assign = __webpack_require__(130);

	var _assign2 = _interopRequireDefault(_assign);

	var _decorators = __webpack_require__(456);
	...
	var App = angular.module('ui-core', ['ui-platform']);

	App.run(['$injector', '$rootScope', 'PlatformService', function (ig, rs, ps) {
	  window.ykConfig = (0, _assign2.default)({}, window.ykConfig, {
	    ig: ig,
	    ps: ps
	  });

	  angular.bootstrap(document.getElementById('yk-navigation'), ['ui-navigation'], { strictDi: true });

	  setTimeout(function () {
	    if (location.hash === '') {
	      if (window.ykConfig.data.defaultApp) {
	        $('#a-' + window.ykConfig.data.defaultApp).click();
	        window.ykConfig.data.appList.forEach(function (item) {
	          var app = _.findWhere(item.items, { ngId: window.ykConfig.data.defaultApp });
	          if (app) {
	            location.href = app.href;
	          }
	        });
	      } else {
	        $('#a-' + window.ykConfig.data.appList[0].items[0].ngId).click();
	        location.href = window.ykConfig.data.appList[0].items[0].href;
	      }
	    } else {
	      var hash = location.hash.split('/');
	      var ele = document.getElementById('a-' + hash[1]);
	      if (typeof ele !== 'undefined' && ele !== null) {
	        angular.element(ele).click();
	        location.hash = hash.join('/');
	      } else if (window.ykConfig.data.defaultApp) {
	        $('#a-' + window.ykConfig.data.defaultApp).click();
	        window.ykConfig.data.appList.forEach(function (item) {
	          var app = _.findWhere(item.items, { ngId: window.ykConfig.data.defaultApp });
	          if (app) {
	...
	// const Header = angular.module('ui-header', ['ui-common']);
	var Navigation = angular.module('ui-navigation', ['ui-common']);
	// const Footer = angular.module('ui-footer', ['ui-common']);
	var UIApp = angular.module('ui-app', ['ui-common']);

	// Header.run(['$state', 'CommonService', '$rootScope', (state, cs, rs) => {
	//   cs.getPlatformRS().$emit('app-loaded', { appName: 'header', state, rs });
	//   state.go('header', {}, { location: false });
	// }]);
	Navigation.run(['$state', 'CommonService', '$rootScope', '$injector', function (state, cs, rs, ig) {
	  cs.getPlatformRS().$emit('app-loaded', { appName: 'navigation', state: state, rs: rs, ig: ig });
	  state.go('navigation', {}, { location: false });
	}]);
	// Footer.run(['$state', 'CommonService', '$rootScope', (state, cs, rs) => {
	//   cs.getPlatformRS().$emit('app-loaded', { appName: 'footer', state, rs });
	//   state.go('footer', {}, { location: false });
	// }]);

	$(window).on('load resize', function () {
	  $('#yk-workarea').css('width', $('body').innerWidth() - $('#yk-navigation').innerWidth());
	});
	...
	var uiAppInject = exports.uiAppInject = d.injectDecorator(UIApp);
	var uiAppConfig = exports.uiAppConfig = d.configDecorator(UIApp);

	/**
	 *  Javascript Decorator to register ng specific functionality
	 * */
	// export const headerService = d.serviceDecorator(Header);
	// export const headerDirective = d.directiveDecorator(Header);
	// export const headerController = d.controllerDecorator(Header);
	// export const headerConfig = d.configDecorator(Header);
	// export const headerInject = d.injectDecorator(Header);

	/**
	 *  Javascript Decorator to register ng specific functionality
	 * */
	var navigationService = exports.navigationService = d.serviceDecorator(Navigation);
	var navigationDirective = exports.navigationDirective = d.directiveDecorator(Navigation);
	var navigationController = exports.navigationController = d.controllerDecorator(Navigation);
	var navigationConfig = exports.navigationConfig = d.configDecorator(Navigation);
	var navigationInject = exports.navigationInject = d.injectDecorator(Navigation);

	/**
	 *  Javascript Decorator to register ng specific functionality
	 * */
	// export const footerService = d.serviceDecorator(Footer);
	// export const footerDirective = d.directiveDecorator(Footer);
	// export const footerController = d.controllerDecorator(Footer);
	// export const footerConfig = d.configDecorator(Footer);
	// export const footerInject = d.injectDecorator(Footer);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = !__webpack_require__(35) && !__webpack_require__(54)(function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _desc, _value, _class; // import header from 'views/header';
	...
	var _ngApp = __webpack_require__(67);
	...
	var ApplicationConfig = (_dec = (0, _ngApp.uiAppInject)('$stateProvider', '$urlRouterProvider'), _dec2 = (0, _ngApp.uiAppConfig)(), _dec3 = (0, _ngApp.appInject)('$stateProvider', '$urlRouterProvider'), _dec4 = (0, _ngApp.appConfig)(), _dec5 = (0, _ngApp.navigationInject)('$stateProvider', '$urlRouterProvider'), _dec6 = (0, _ngApp.navigationConfig)(), (_class = function () {
	  ...
	  (0, _createClass3.default)(ApplicationConfig, [{
	    key: 'uiAppConfig',
	    value: function uiAppConfig(sp, urp) {
	      // eslint-disable-line
	      urp.deferIntercept();
	    }
	  }, {
	    key: 'appConfig',
	    value: function appConfig(sp, urp) {
	      // eslint-disable-line class-methods-use-this
	      urp.when('/:module/:view', ['$match', 'PlatformService', function ($match, ps) {
	        ps.go($match.module + ':' + $match.view);
	      }]);
	      // urp.otherwise(($injector, $location) => {
	      //   console.log(' other wise ..?');
	      // });
	    }
	  }, {
	    key: 'navigationConfig',
	    value: function navigationConfig(sp, urp) {
	      // eslint-disable-line class-methods-use-this
	      sp.state('navigation', _navigation2.default);
	      urp.deferIntercept();
	    }
	  }]);
	  return ApplicationConfig;
	}(), (_applyDecoratedDescriptor(_class.prototype, 'uiAppConfig', [_dec, _dec2], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'uiAppConfig'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'appConfig', [_dec3, _dec4], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'appConfig'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'navigationConfig', [_dec5, _dec6], (0, _getOwnPropertyDescriptor2.default)(_class.prototype, 'navigationConfig'), _class.prototype)), _class));
...
/***/ (function(module, exports) {
	...
	var MOCK_HTTP = exports.MOCK_HTTP = false;
	var APP_CONFIG = exports.APP_CONFIG = {
	  title: 'BrideClick Portal',
	  configURL: '/api/platform-config'
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PlatformService = (_dec = (0, _ngApp.appInject)('$rootScope'), _dec2 = (0, _ngApp.appService)({ name: 'PlatformService' }), _dec(_class = _dec2(_class = function () {
	  // eslint-disable-line no-unused-vars
	  function PlatformService(rs) {
	    var _this = this;

	    (0, _classCallCheck3.default)(this, PlatformService);

	    this.uiStateCache = {};
	    this.rs = rs;
	    this.currentApp = null;
	    this.rs.$on('app-loaded', function (e, param) {
	      _this.uiStateCache[param.appName] = param;
	      if (param.initialApplicationView) {
	        _this.go(param.initialApplicationView.replace('/', ':'));
	      }
	    });
	  }

	  (0, _createClass3.default)(PlatformService, [{
	    key: 'go',
	    value: function go(appState) {
	      var _this2 = this;

	      if (!appState) return;

	      var state = appState.split('/').map(function (mv) {
	        return mv.split(':');
	      });
	      state.forEach(function (i) {
	        var app = _this2.uiStateCache[i[0]];
	        if (app) {
	          /*
	           if app is not current app;
	           * */
	          if (_this2.currentApp !== app) {
	            if (_this2.currentApp) {
	              $(_this2.currentApp.ig.get('$rootElement')).hide();
	            }
	            $(app.ig.get('$rootElement')).show();
	            _this2.currentApp = app; // set new application;
	          }

	          var apps = app.state;
	          apps.go(i[1], {}, { location: false });
	        } else {
	          console.warn(' no application definition found');
	        }
	      });
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var configData = new _promise2.default(function (resolve, reject) {
	    $.getJSON(_constants.APP_CONFIG.configURL).done(function (json) {
	        resolve(json);
	     ...
	     * Created by Akhil on 24-09-2016.
	     */
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _appErrors = __webpack_require__(188);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _view = __webpack_require__(454);

	var _view2 = _interopRequireDefault(_view);

	var _BaseController2 = __webpack_require__(195);
	...
	var ViewController = (_dec = (0, _ngApp.navigationController)(), _dec2 = (0, _ngApp.navigationInject)('$scope', '$injector'), _dec(_class = _dec2(_class = function (_BaseController) {
	  (0, _inherits3.default)(ViewController, _BaseController);

	  function ViewController() {
	    (0, _classCallCheck3.default)(this, ViewController);

	    // eslint-disable-line prefer-rest-params
	    var _this = (0, _possibleConstructorReturn3.default)(this, (ViewController.__proto__ || (0, _getPrototypeOf2.default)(ViewController)).call(this, arguments));
	  ...
	  (0, _createClass3.default)(ViewController, [{
	    ...
	    value: function init() {
	      ...
	      var appConfig = window.ykConfig && window.ykConfig.data;
	      if (!appConfig) {
	        return;
	      }
	      ...
	      this.toggleExpand = function () {
	        if (_this2.expanded) {
	          angular.element(document.getElementById('yk-navigation')).removeClass('expanded-menu');
	        } else {
	          angular.element(document.getElementById('yk-navigation')).addClass('expanded-menu');
	        }
	        $('#yk-workarea').css('width', $('body').innerWidth() - $('#yk-navigation').innerWidth());
	        _this2.expanded = !_this2.expanded;
	      };

	      this.model.appList = appConfig.appList;
	      this.model.appInfo = appConfig.cms;
	      this.model.userInfo = appConfig.userContext;
	      this.model.lastupdated = '2016-12-24';
	    }
	  }, {
	    key: 'mapDI',
	    get: function get() {
	...
	exports.default = {
	  url: '/', template: _view2.default, controller: ViewController, controllerAs: 'vm',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _platformConfingLoader = __webpack_require__(194);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	$(document).ready(function () {
	  (0, _platformConfingLoader.getConfigData)().then(function (data) {
	    window.ykConfig = (0, _assign2.default)({}, window.ykConfig, {
	      data: data
	    });
	    angular.bootstrap(document.getElementById('app-platform'), ['ui-core'], { strictDi: true }); /* Boot Strapping NgApp*/
	  });
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
	__webpack_require__(42)(IteratorPrototype, __webpack_require__(14)('iterator'), function () { return this; });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function (test, buggy, set) {
	      try {
	        set = __webpack_require__(61)(Function.call, __webpack_require__(95).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
	        buggy = !(test instanceof Array);
	      } catch (e) { buggy = true; }
	      return function setPrototypeOf(O, proto) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(35), 'Object', { defineProperty: __webpack_require__(37).f });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var userAgent = __webpack_require__(239);
	...
	__webpack_require__(236)(PROMISE);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(26);
	var redefine = __webpack_require__(146);
	var META = __webpack_require__(229).KEY;
	var $fails = __webpack_require__(54);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(1);
	var $re = __webpack_require__(258)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(7), 'Object', { defineProperties: __webpack_require__(171) });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export = __webpack_require__(1);
	var $at = __webpack_require__(121)(false);
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"app-info-block\">\n    <div class=\"app-info-details\">\n        <span class=\"sidebar-toggler\" ng-click=\"vm.toggleExpand()\">\n            <span class=\"icon-custom icon-list\"></span>\n        </span>\n        <a class=\"brand-logo\" href=\"#\">\n            <img src=\"{{vm.model.appInfo.logo}}\" alt=\"{{vm.model.appInfo.appName}}\">\n        </a>\n    </div>\n    <div class=\"user-details\">\n        <div class=\"user-image\">\n            <img src=\"{{vm.model.userInfo.avtar}}\">\n        </div>\n        <div class=\"user-name\">\n            {{vm.model.userInfo.username}}\n        </div>\n        <div class=\"user-role\">\n            {{vm.model.userInfo.role}}\n        </div>\n    </div>\n    <!--<div class=\"app-last-update\">\n        Last Updated: {{vm.model.lastupdated}}\n    </div>-->\n</div>\n<yk-accordion list=\"vm.model.appList\"></yk-accordion>\n";

/***/ }),
/* 455 */
/***/ (function(module, exports) {

	var path = 'views/navigation/view.html';
	var html = "<div class=\"app-info-block\">\n    <div class=\"app-info-details\">\n        <span class=\"sidebar-toggler\" ng-click=\"vm.toggleExpand()\">\n            <span class=\"icon-custom icon-list\"></span>\n        </span>\n        <a class=\"brand-logo\" href=\"#\">\n            <img src=\"{{vm.model.appInfo.logo}}\" alt=\"{{vm.model.appInfo.appName}}\">\n        </a>\n    </div>\n    <div class=\"user-details\">\n        <div class=\"user-image\">\n            <img src=\"{{vm.model.userInfo.avtar}}\">\n        </div>\n        <div class=\"user-name\">\n            {{vm.model.userInfo.username}}\n        </div>\n        <div class=\"user-role\">\n            {{vm.model.userInfo.role}}\n        </div>\n    </div>\n    <!--<div class=\"app-last-update\">\n        Last Updated: {{vm.model.lastupdated}}\n    </div>-->\n</div>\n<yk-accordion list=\"vm.model.appList\"></yk-accordion>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (__webpack_require__(187))(41);

/***/ }),
/* 457 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = (__webpack_require__(187))(79);
